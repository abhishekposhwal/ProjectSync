...
import { getAllGroup, registerGroup, deleteGroup } from '../../Api/groupApi'; // Assuming registerCourse is exported from the API file
...
export default function Group() {
    ...
    if (userData && userData.data) {
        ...
        data = userData.data.map((group) => ({
            _id: group._id, // Include the _id in the data
            "Group Name": group.name
        }));
    }


    const addButtonName = "Add New Group";

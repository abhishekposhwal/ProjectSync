                    ...
                    <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded bg-white">
                        <div className="block w-full overflow-x-auto">
                            <section className="max-w-4xl p-6 mx-auto  dark:bg-white-800">
                                <h2 className="text-lg font-semibold text-black-700 capitalize dark:text-black">Search Submission By Group</h2>
                                <form>
                                    <div className="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-1">
                                        <div>
                                            ...
                                            <select
                                                ...
                                                className="block w-full px-4 py-2 mt-2 text-black-700 bg-white border rounded-md dark:bg-white-800 dark:text-black-300 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring"
                                            >
                                    ...
                                    <div className="flex justify-end mt-6">
                                        <button onClick={fetchProjectsByGroup} className="bg-lightBlue-500 text-white active:bg-lightBlue-600 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 ease-linear transition-all duration-150flex items-center justify-center w-1/2 px-5 py-2 text-xs tracking-wide text-white transition-colors duration-200 bg-blue-500 rounded-lg shrink-0 sm:w-auto gap-x-2 hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-blue-600">Search</button>
                                    </div>
                                </form>
                            </section>
                        </div>
                                ...
                                <div className="max-w-2xl overflow-hidden dark:bg-white-800 m-4">
                                    ...
                                    <div className="p-6">
                                        ...
                                        <div>
                                            ...
                                            <p className="mt-2 text-sm text-gray-600 dark:text-black-400">
